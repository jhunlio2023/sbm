            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?= form_open('Page/tapr_admin_update', $att); ?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div id="accordion" class="mb-3">
                                                                            ...
                                                                            <tbody>
                                                                                <?php 
                                                                                    ...
                                                                                    foreach($question as $sub_row){
                                                                                        ...
                                                                                        $sbm = $this->Common->two_cond_row('sbm','school_id',$this->uri->segment(3),'fy',date('Y'));
                                                                                ...
                                                                                <tr <?php echo (++$c%2 ? "" : "class='table-active'"); ?>>
                                                                                    ...
                                                                                    <td><textarea class="form-control" name="fs<?=$sub_row->i_no; ?>" rows="2" id="example-textarea" readonly><?= $sbm_remark->$count5; ?></textarea></td>
                                                                                    <td><textarea class="form-control" name="r<?=$sub_row->i_no; ?>" rows="2" id="example-textarea" readonly><?= $sbm_remark->$count4; ?></textarea></td>
                                                                                    <td><textarea class="form-control" name="fs<?=$sub_row->i_no; ?>" rows="2" id="example-textarea"><?= $sbm_remark_admin->$count5; ?></textarea></td>
                                                                                    <td><textarea class="form-control" name="r<?=$sub_row->i_no; ?>" rows="2" id="example-textarea"><?= $sbm_remark_admin->$count4; ?></textarea></td>
                                                                                </tr>
                                                                                <?php } ?>
                                        ...
                                        <input type="hidden" name="id" value="<?= $sbm_remark_admin->id; ?>">
