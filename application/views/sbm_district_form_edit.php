            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?= form_open('Page/sbm_d_update', $att); ?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div id="accordion" class="mb-3">
                                                                        ...
                                                                        <table class="table table-borderless mb-0">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr <?php echo (++$c%2 ? "" : "class='table-active'"); ?>>
                                                                                    ...
                                                                                    <?php if($this->session->position == 'District' || $this->session->position == 'smme'){?><td><textarea class="form-control" name="r<?=$sub_row->i_no; ?>" rows="2" id="example-textarea"><?= $sbmcr->$name; ?></textarea></td><?php } ?>
                                                                                </tr>
                                                                                <?php } ?>
                                        ...
                                        <?php } ?>
                                        <input type="hidden" value="<?= $sbmcr->id; ?>" name="id">
