                                                                        ...
                                                                        <table class="table table-borderless mb-0">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr <?php echo (++$c%2 ? "" : "class='table-active'"); ?>>
                                                                                    ...
                                                                                    <td><textarea class="form-control" name="f<?=$sub_row->i_no; ?>" rows="2" id="example-textarea" readonly><?php if($sbmc_count->num_rows() >= 1){echo $sbmc->$count3;} ?></textarea></td>
                                                                                    <td><textarea class="form-control" name="fs<?=$sub_row->i_no; ?>" rows="2" id="example-textarea" readonly><?php if(!empty($sbm_remark)){echo $sbm_remark->$count;} ?></textarea></td>
                                                                                    <td><textarea class="form-control" name="r<?=$sub_row->i_no; ?>" rows="2" id="example-textarea" readonly><?php if(!empty($sbm_remark)){echo $sbm_remark->$count4;} ?></textarea></td>
                                                                                    <td><textarea class="form-control" name="fs<?=$sub_row->i_no; ?>" rows="2" id="example-textarea"></textarea></td>
                                                                                    <td><textarea class="form-control" name="r<?=$sub_row->i_no; ?>" rows="2" id="example-textarea"></textarea></td>
                                                                                </tr>
                                                                                <?php } ?>
