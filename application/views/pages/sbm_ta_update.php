<!-- start page title -->
                        ...
                        <?= form_open('Pages/tapr_form_update', $att); ?>
                                                                            ...
                                                                            <tbody>
                                                                                <?php 
                                                                                    ...
                                                                                    foreach($question as $sub_row){
                                                                                        ...
                                                                                        $sbm = $this->Common->two_cond_row('sbm','school_id',$this->session->username,'fy',$this->session->fy);
                                                                                ...
                                                                                <tr <?php echo (++$c%2 ? "" : "class='table-active'"); ?>>
                                                                                    ...
                                                                                    <select class="form-control" name="a<?=$sub_row->i_no; ?>" >
                                                                                        ...
                                                                                        <?php foreach($cat as $key => $row){ ?>
                                                                                            <option <?php if($key == $sbmc->$count2){echo " selected ";} ?> value="<?= $key; ?>"><?= $row; ?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                    </td>
