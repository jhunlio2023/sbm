...
<style>
    ...
    .district-form-group .form-control[readonly] {
        background: #f8f9fa;
        cursor: not-allowed;
    }
    ...
    <div class="row">
        <div class="col-12">
            <div class="district-form-hero">
                <div>
                    <h2><i class="mdi mdi-plus-circle-outline mr-2"></i>Add New District</h2>
                    <p>Create a new district for <?= html_escape(mb_convert_case($division_name, MB_CASE_TITLE, 'UTF-8')); ?>.</p>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="district-form-header">
                        <div>
                            ...
                            <p>Enter the district details below.</p>
                        </div>
                    </div>

                    <div class="district-form-body">
                        <?php $att = array('class' => 'parsley-examples'); ?>
                        <?= form_open('pages/district_new', $att); ?>

                            <div class="form-row">
                                <div class="form-group col-md-12 district-form-group">
                                    <label for="description">District Name</label>
                                    <input type="text" id="description" required class="form-control" name="description" value="" placeholder="Enter district name">
                                </div>
                            ...
                            <div class="district-form-actions">
                                <a href="<?= base_url(); ?>pages/district_account/<?= $division->id; ?>" class="btn btn-secondary">
