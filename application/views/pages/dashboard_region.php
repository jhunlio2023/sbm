                                        ...
                                        <ol class="breadcrumb p-0 m-0">
                                            <li class="breadcrumb-item">
                                                <a href="#" data-toggle="modal" data-target="#myModal"
                                                    ...
                                                    <span class="font-weight-bold">Current Fiscal Year:</span>
                                                    <span class="badge badge-pill badge-success ml-2 px-3 py-2 shadow-sm">
                                                        <?= $this->session->fy; ?>
                                                    </span>
                                                </a>
                                            </li>
                                        ...
                                        <div id="accordion" class="mb-3">
                                            ...
                                            foreach ($sbm as $row) { ?>
                                                <div class="card mb-0">
                                                    ...
                                                    <div id="collapse<?= $row->id; ?>" class="collapse <?php if ($row->id == 1) {
                                                                                                            echo 'show';
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            <th rowspan="2" colspan="2">
                                                                                <h4 class="header-title mb-4">SBM Indicator</h4>
                                                                            </th>
