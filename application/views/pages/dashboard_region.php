...
<div class="region-dashboard">
    <div class="dashboard-hero">
        <div>
            ...
            <p>Monitor division performance, school signups, governance status, and checklist results across your region.</p>
        </div>
        <div class="dashboard-hero-actions">
            ...
            <a href="<?= $tana_summary_url; ?>" class="dashboard-hero-link">
    ...
    <div class="row dashboard-stats">
        <div class="col-md-6 col-xl-3">
            <a href="<?= $school_directory_url; ?>" class="dashboard-stat-link" title="View school signup details">
        ...
        <div class="col-md-6 col-xl-3">
            <a href="<?= $division_list_url; ?>" class="dashboard-stat-link" title="View division setup status">
                <div class="dashboard-stat-card">
                    <div class="dashboard-stat-top">
                        <div>
                            <h3><?= $encoded_school_total; ?></h3>
                            <p>Total Schools</p>
                            <span class="dashboard-link-hint"><i class="mdi mdi-arrow-right"></i> View divisions</span>
                        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <a href="<?= $school_directory_url; ?>" class="dashboard-stat-link" title="View signup coverage details">
                <div class="dashboard-stat-card">
                    <div class="dashboard-stat-top">
                        <div>
        ...
        <div class="col-md-6 col-xl-3">
            <a href="<?= $school_directory_url; ?>" class="dashboard-stat-link" title="Browse districts through divisions">
                <div class="dashboard-stat-card">
                    <div class="dashboard-stat-top">
                        <div>
                            <h3><?= $district_total; ?></h3>
                            <p>Districts in the Region</p>
    ...
    <section class="dashboard-panel">
        ...
        <div class="dashboard-panel-body">
            <div class="sgc-status-grid">
                <a href="<?= $school_directory_url; ?>" class="dashboard-count-link" title="View regional signup progress">
    ...
    <section class="dashboard-panel">
        <div class="dashboard-panel-header">
            <div>
                ...
                <p>Current SGC organization and functionality across monitored schools in the region.</p>
            </div>
