    ...
    <div class="row">
        <div class="col-12">
            <div class="report-hero">
                <div>
                    <h2><i class="mdi mdi-chart-line mr-2"></i>Division Submission Report</h2>
                    <p>View submission statistics and completion rates for each division including Action Plan, Self-Assessment, and TNA forms.</p>
                </div>
                ...
                <div class="card-body">
                    <div class="report-card-header">
                        <div>
                            ...
                            <p>Submission completion rates per division for the current fiscal year.</p>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="stat-cell">
                                                ...
                                                <div class="progress-wrapper">
                                                    ...
                                                    <span class="percentage-text"><?= html_escape($row->action_plan_percentage); ?>%</span>
                                                </div>
                                            </td>
                                            <td class="stat-cell">
                                                ...
                                                <div class="progress-wrapper">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-info" style="width: <?= html_escape($row->sbm_percentage); ?>%;"></div>
                                                    </div>
                                                    <span class="percentage-text"><?= html_escape($row->sbm_percentage); ?>%</span>
                                                </div>
                                            </td>
                                            <td class="stat-cell">
                                                ...
                                                <div class="progress-wrapper">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-primary" style="width: <?= html_escape($row->sbm_ta_percentage); ?>%;"></div>
                                                    </div>
                                                    <span class="percentage-text"><?= html_escape($row->sbm_ta_percentage); ?>%</span>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
