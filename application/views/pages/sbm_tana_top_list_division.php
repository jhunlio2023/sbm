                                                                            ...
                                                                            <tbody>
                                                                              <?php  foreach($ivy as $row){
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a onclick="return confirm('Are You Sure?')" href="<?= base_url(); ?>Pages/tana_division_delete/<?= $row->id; ?>" class="btn btn-danger btn-sm">Delete</a>
                                                                                    </td>
                                                                                </tr>
                                                                                <?php } ?>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <?= form_open('Pages/tana_division', $att); ?>
