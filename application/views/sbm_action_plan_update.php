                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <?= form_open(base_url().'Page/sbm_action_plan_edit'); ?>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-lg-4">
                                                                    ...
                                                                    <input type="text" name="time_frame" parsley-trigger="change" placeholder="Time Frame" class="form-control" value="<?= $data->time_frame; ?>">
                                                                </div>
                                                                <div class="form-group col-lg-4">
                                                                    <label for="emailAddress">Person Involved</label>
                                                                    <input type="text" name="person_involved" parsley-trigger="change" placeholder="Person Involved" class="form-control" value="<?= $data->person_involved; ?>">
                                                                </div>
                                                                <div class="form-group col-lg-4">
                                                                    <label for="userName">Budgetary Requirement</label>
                                                                    <input type="text" name="bud_req" parsley-trigger="change" placeholder="Budgetary Requirement" class="form-control" value="<?= $data->bud_req; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-lg-12">
                                                                    ...
                                                                    <textarea class="form-control" rows="2" name="remarks" id="example-textarea"><?= $data->activity; ?></textarea>
                                                                </div>
                                                            </div>
