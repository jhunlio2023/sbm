                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <?= form_open(base_url().'Page/tapr_form_edit'); ?>
                                                            <div class="row">
                                                                <div class="form-group col-lg-4">
                                                                    <label for="userName">SBM Indicators</label>
                                                                        <select class="form-control" name="indicator_id">
                                                                        <?php foreach($indicator as $row){ ?>
                                                                        <option <?php if($row->id == $data->indicator_id){echo "selected"; } ?> value="<?= $row->id; ?>"><?= $row->indicator; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-lg-8">
                                                                    ...
                                                                    <input type="text" class="form-control" value="<?= $data->dm; ?>" name="dm">  
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-lg-12">
                                                                    ...
                                                                    <textarea class="form-control" rows="2" name="cigpb" id="example-textarea"><?= $data->cigpb; ?></textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-lg-8">
                                                                    ...
                                                                    <input type="text" class="form-control" value="<?= $data->prc; ?>" name="prc">  
                                                                </div>
                                                            </div>
